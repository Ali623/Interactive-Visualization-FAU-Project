...
classifier = joblib.load('svm_PCA100_model.joblib')
pca = joblib.load('PCA100_model(svm).joblib')

# Load the saved models
# classifier = joblib.load('random_forest_model_PCA.joblib')
# pca = joblib.load('SVM_ensemble_pca100_model.joblib')
